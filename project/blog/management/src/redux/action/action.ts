...
export const requestData = (category: string) => ({
    type: REQUEST_DATA,
    category,
})

// 数据响应后 触发 receive action ；并改变isFetching值为false
export const receiveData = (data: any, category: string) => ({
    type: RECEIVE_DATA,
    data,
    category,
})
...
// 新增数据
export const addData = (data: any, category: string) => ({
    type: ADD_DATA,
    data,
    category,
})
...
// 重新加载数据
export const reloadData = (data: any, category: string) => ({
    type: RELOAD_DATA,
    data,
    category,
})